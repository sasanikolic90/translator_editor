...
(function ($, Drupal, CKEDITOR) {
  ...
  CKEDITOR.plugins.add('drupalLineBreak', {
    requires: 'image2',
    ...
    beforeInit: function (editor) {
      ...
      editor.on('widgetDefinition', function (event) {
        ...
        // for extending, so that both this basic drupalLineBreak plugin and Drupal
        ...
        // a bug in CKEditor. In the case of drupalLineBreak, we don't ever want to
      ...
      editor.addCommand('editdrupalimage', {
        ...
        exec: function (editor, data) {
          ...
          var find = editor.editable().$.innerHTML;
          editor.editable().$.innerHTML = find.replace(new RegExp('<br>', 'gm'), data.dialogTitle);
        }
      });
  ...
  /**
   * Integrates the drupalLineBreak widget with the drupallink plugin.
   *
  ...
  // Expose an API for other plugins to interact with drupalLineBreak widgets.
  CKEDITOR.plugins.drupalLineBreak = {
